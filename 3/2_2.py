...
screen.blit(pygame.transform.smoothscale(house,(300,300)),(10,300))
screen.blit(pygame.transform.smoothscale(tree,(216,300)),(320,280))
screen.blit(pygame.transform.smoothscale(house,(150,150)),(540,350))
screen.blit(pygame.transform.smoothscale(tree,(108,150)),(690,330))
screen.blit(pygame.transform.smoothscale(cloud,(200,120)),(550,100))
screen.blit(pygame.transform.smoothscale(cloud,(100,60)),(350,150))
screen.blit(pygame.transform.smoothscale(cloud,(150,90)),(140,100))
screen.blit(pygame.transform.smoothscale(sun,(100,100)),(50,50))
#события
